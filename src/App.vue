<template>
  <div class="min-h-screen bg-gray-200 py-8 px-4 flex justify-center  transition-colors duration-300 font-sans">

    <!-- bouton pour modifier et changer le thème -->
    <div class="top-8 right-8 fixed flex gap-3 z-10"> 
      ...
      <button @click="toggleDarkMode" class="rounded-full bg-gray-800 hover:bg-gray-900 text-white p-3 shadow-lg transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer">
    ...
    <!-- Contenu du CV -->
    <div class="bg-white w-full max-w-[210mm] min-h-[297mm] shadow-2xl relative transition-colors duration-200 overflow-hidden">
      <!-- decoration du haut -->
      <div class="h-6 bg-[#008080] w-1/3"></div>

      <!-- decoration du coté droit -->
      <div class="hidden h-1/2 bg-[#008080] top-0 right-0 w-[25px] absolute"></div>
